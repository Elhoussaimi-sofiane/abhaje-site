# ABHAJE & Frères — version statique

Cette copie fonctionne uniquement avec HTML, CSS et JavaScript natifs.

- `index.html` : contenu et structure
- `styles.css` : design responsive
- `animations.css` / `motion.js` : animations GSAP + ScrollTrigger répétées dans les deux sens et défilement fluide Lenis
- `script.js` : carrousel du hero
